...
sudo aws s3 sync s3://olakib-nest-webfiles /var/www/html
...
sudo aws s3 cp s3://nest-appservice-prov/AppServiceProviders.php /var/www/html/app/Providers/AppServiceProvider.php
